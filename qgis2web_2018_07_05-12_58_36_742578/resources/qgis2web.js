...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [110976.093373, 477981.632430, 130966.846443, 494981.632430], maxZoom: 28, minZoom: 1, projection: new ol.proj.Projection({
            code: 'EPSG:28992',
            extent: [110976.093373, 477981.632430, 130966.846443, 494981.632430],
            units: 'm'})
    })
});
...
map.getView().fit([110976.093373, 477981.632430, 130966.846443, 494981.632430], map.getSize());
