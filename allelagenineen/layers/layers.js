...
lyr_centraalna_1.set('fieldAliases', {'modussecvoorcentraal': 'modussecvoorcentraal', 'modussecnacentraal': 'modussecnacentraal', });
lyr_zuidna_2.set('fieldAliases', {'modussecvoorzuid': 'modussecvoorzuid', 'modussecnazuid': 'modussecnazuid', });
lyr_secverschilcentraal_3.set('fieldAliases', {'modussecvoorcentraal': 'modussecvoorcentraal', 'modussecnacentraal': 'modussecnacentraal', 'secverschilcentraal': 'secverschilcentraal', });
lyr_secverschilzuid_4.set('fieldAliases', {'modussecvoorzuid': 'modussecvoorzuid', 'modussecnazuid': 'modussecnazuid', 'secverschilzuid': 'secverschilzuid', });
...
lyr_centraalna_1.set('fieldLabels', {'modussecvoorcentraal': 'no label', 'modussecnacentraal': 'no label', });
lyr_zuidna_2.set('fieldLabels', {'modussecvoorzuid': 'no label', 'modussecnazuid': 'no label', });
lyr_secverschilcentraal_3.set('fieldLabels', {'modussecvoorcentraal': 'no label', 'modussecnacentraal': 'no label', 'secverschilcentraal': 'no label', });
lyr_secverschilzuid_4.set('fieldLabels', {'modussecvoorzuid': 'no label', 'modussecnazuid': 'no label', 'secverschilzuid': 'no label', });
